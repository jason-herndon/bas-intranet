...
class TitanFrameworkOptionDate extends TitanFrameworkOption {
	...
	public function enqueueDatepicker() {
		...
		wp_enqueue_script( 'tf-jquery-ui-timepicker-addon', get_template_directory_uri() . '/library/frameworks/bas-framework/js/jquery-ui-timepicker-addon.js', array( 'jquery-ui-datepicker', 'jquery-ui-slider' ) );
	}
