...
<li id="acomment-<?php bp_activity_comment_id(); ?>" class="well well-sm">
	...
	<div class="acomment-content text-left"><?php bp_activity_comment_content(); ?></div>
	...
	<div class="acomment-options text-right">
		...
		<?php if ( is_user_logged_in() && bp_activity_can_comment_reply( bp_activity_current_comment() ) ) : ?>
			...
			<a href="#acomment-<?php bp_activity_comment_id(); ?>" class="acomment-reply bp-primary-action text-success btn-xs" id="acomment-reply-<?php bp_activity_id(); ?>-from-<?php bp_activity_comment_id(); ?>"><?php _e( 'Reply', 'firmasite' ); ?></a>

		<?php endif; ?>

		<?php if ( bp_activity_user_can_delete() ) : ?>

			<a href="<?php bp_activity_comment_delete_link(); ?>" class="delete acomment-delete confirm bp-secondary-action text-danger btn-xs" rel="nofollow"><?php _e( 'Delete', 'firmasite' ); ?></a>
