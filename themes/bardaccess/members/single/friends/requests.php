		...
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>">
			 <div class="panel panel-default"><div class="panel-body">
				...
				<?php /*	<div class="item-meta"><span class="label label-default activity"><?php bp_member_last_active(); ?></span></div> */ ?>
				</div>

				<?php do_action( 'bp_friend_requests_item' ); ?>

				<div class="action">
					<a class="btn btn-success btn-xs button accept" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'firmasite' ); ?></a> &nbsp;
					<a class="btn btn-danger btn-xs button reject" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'firmasite' ); ?></a>
