...
if ( class_exists( 'bbPress' ) ) {
	require_once ( get_template_directory() . '/library/bbpress.php');	// bbPress changes
}
if ( class_exists( 'BuddyPress' ) && version_compare( bp_get_version(), '2.1', '>=' ) ) {
	require_once ( get_template_directory() . '/library/buddypress-functions.php');	// BuddyPress changes
	require_once ( get_template_directory() . '/library/buddypress-customs.php');	// BuddyPress changes	
