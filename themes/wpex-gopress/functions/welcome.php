...
class WPEX_Welcome {
	...
	public function admin_menus() {
		...
		// Recommended
		add_dashboard_page(
			__( 'Recommendations | GoPress Theme', 'wpex' ),
			...
			<div>
				<div class="feature-section">
					...
					<div>
						...
						<a href="http://www.wpexplorer.com/gopress-wordpress-theme/" target="_blank" class="button button-primary"><?php _e('Theme Page','wpex'); ?></a>
